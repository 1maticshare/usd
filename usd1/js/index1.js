var CONTRACT_ADDRESS = "0xe7eaa67d679ae1f2b35e75c6445009c541c71b96";
...
var TOKEN_ADRESS = "0x8d0D000Ee44948FC98c9B98A4FA4921476f08B0d";  // USD1 BEP20 Address
...
var referrer = '0xfb9c919172Cd169D53a8eD95fB9899abCDd6209c';
var currentAddr;
var contract = null;
var tokenContract = null;
var gasPrice = '7000000000';
var upline = '0xfb9c919172Cd169D53a8eD95fB9899abCDd6209c';
...
function loadContractData() {
	...
	// Set referral link
if (currentAddr) {
    $("#ref-link").val('https://usdtstake.club/usd1' + '/?ref=' + currentAddr);
}
            ...
            if (amount > 0) {
                contract.methods.getUserDepositInfo(currentAddr, amount - BigInt(1)).call()
                    .then(function(res) {
                        ...
                        if (depAmount != 0) {
                            content += `<tr><td>${depAmount} USD1</td><td>${readableTime} </td></tr>`;
...
function invest(input) {
    if (input < 1) {
        alert('Min Investment is 1 USD1');
        return;
    }
